...
| ----------------- | --------- | -------- | --------- | ---------- | ----------- |
| 平面结构 × 100    | 9.6 ms    | 7.9 ms   | **1.21x** | 2.8 ms     | **3.4x**    |
| 平面结构 × 500    | 47.1 ms   | 35.5 ms  | **1.32x** | 11.3 ms    | **4.2x**    |
| 平面结构 × 1000   | 116.9 ms  | 76.8 ms  | **1.52x** | 48.7 ms    | **2.4x**    |
| 平面结构 × 5000   | 455.8 ms  | 52.0 ms  | **8.76x** | 28.7 ms    | **15.9x**   |
| 5层嵌套 × 10      | 17.6 ms   | 12.9 ms  | **1.37x** | 4.4 ms     | **4.0x**    |
| 5层嵌套 × 50      | 105.3 ms  | 63.0 ms  | **1.67x** | 18.7 ms    | **5.6x**    |
| 5层嵌套 × 100     | 195.0 ms  | 53.4 ms  | **3.65x** | 13.5 ms    | **14.5x**   |
| 大数据(10k)       | 45.0 ms   | 13.1 ms  | **3.42x** | 5.3 ms     | **8.5x**    |

### 反序列化（ASON 快 1.1–2.7 倍）

| 场景              | JSON      | ASON     | 加速比    |
| ----------------- | --------- | -------- | --------- |
| 平面结构 × 100    | 19.0 ms   | 16.4 ms  | **1.16x** |
| 平面结构 × 500    | 106.3 ms  | 98.5 ms  | **1.08x** |
| 平面结构 × 1000   | 209.2 ms  | 88.7 ms  | **2.36x** |
| 平面结构 × 5000   | 409.1 ms  | 255.6 ms | **1.60x** |
| 5层嵌套 × 50      | 196.8 ms  | 73.9 ms  | **2.66x** |
| 5层嵌套 × 100     | 382.5 ms  | 173.4 ms | **2.21x** |
| 大数据(10k)       | 142.8 ms  | 108.6 ms | **1.31x** |
